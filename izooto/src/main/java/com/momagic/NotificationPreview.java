             ...
             final Runnable notificationRunnable = new Runnable() {
                 ...
                 public void run() {
                     ...
                     try {
                         ...
                         boolean isDarkThemeOn = (DATB.appContext.getResources().getConfiguration().uiMode & Configuration.UI_MODE_NIGHT_MASK) == Configuration.UI_MODE_NIGHT_YES;
//        if (isDarkThemeOn) {
...
//                    PendingIntent sendPendingIntent = PendingIntent.getBroadcast(DATB.appContext, new Random().nextInt(100), intentShareBtn, PendingIntent.FLAG_UPDATE_CURRENT);
...
//                }else
                         ...
                         Util.setException(DATB.appContext, e.toString(), "receiveCustomNotification", "NotificationCustomView");
                         e.printStackTrace();
                     }
...
//                    }
    ...
    public static PendingIntent shareNotification(String url) {
        if(url!=null && !url.isEmpty()) {
            ...
            return PendingIntent.getActivity(DATB.appContext, new Random().nextInt(100), sendIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        }
        else
        {
            Intent sendIntent = new Intent();
